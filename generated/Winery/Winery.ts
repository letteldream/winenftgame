...
export class Winery__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class Winery extends ethereum.SmartContract {
  static bind(address: Address): Winery {
    return new Winery("Winery", address);
  }
  ...
  royaltyInfo(tokenId: BigInt, value: BigInt): Winery__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new Winery__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<Winery__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Winery__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
